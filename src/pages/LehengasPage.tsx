...
const LehangaPage = () => {
  ...
  const [selectedStyle, setSelectedStyles] = useState<string[]>([]);
  ...
  const filters: LehengaFilters = {
    search: search || undefined,
    styles: selectedStyle.length > 0 ? selectedStyle : undefined,
    ...
    inStock,
    isFastDelivery: isFastDelivery || undefined,
    isNew,
    isBestseller,
    sortBy,
    page: currentPage,
  ...
  const {
    ...
    queryFn: () => lehengaAPI.getLehengas(filters),
  ...
  const { data: filterOptions } = useQuery({
    ...
    queryFn: () => lehengaAPI.getFilterOptions(),
  ...
  const sarees = sareesData?.lehengas || [];
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setIsFastDelivery(checked === true)
                      }
                    />
                    <label
                      htmlFor="isFastDelivery"
              ...
              {filterOptions && (
                <>
                    ...
                    <div className="space-y-2 max-h-32 overflow-y-auto scrollbar-hide">
                      {filterOptions?.styles?.map((style) => (
                        ...
                        >
                          ...
                          />
                          <label htmlFor={`type-${style}`} className="text-sm">
                            {style}
                          </label>
                        </div>
                      ))}
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="space-y-2 max-h-32 overflow-y-auto scrollbar-hide">
                      {filterOptions?.workTypes?.map((workTypes) => (
                        <div
                          key={workTypes}
                          className="flex items-center space-x-2"
                        >
                          <Checkbox
                            id={`type-${workTypes}`}
                            checked={selectedworkTypes.includes(workTypes)}
                            onCheckedChange={() =>
                              toggleFilter(
                                workTypes,
                                selectedworkTypes,
                    ...
                    <div className="space-y-2 max-h-32 overflow-y-auto scrollbar-hide">
                      {filterOptions?.sizes?.map((sizes) => (
                        ...
                        >
                          ...
                          />
                          <label htmlFor={`type-${sizes}`} className="text-sm">
                            {sizes}
                          </label>
                        </div>
                      ))}
            ...
            {(selectedStyle.length > 0 ||
              ...
              <div className="mb-6 p-4 bg-muted/30 rounded-lg">
                <div className="flex flex-wrap gap-2 items-center">
                  ...
                  {selectedStyle.map((type) => (
                    <Badge key={type} variant="secondary" className="gap-1">
                      {type}
                      <button
                        onClick={() =>
                          toggleFilter(type, selectedStyle, setSelectedStyles)
                        }
                      >
                        ×
                      </button>
                  ...
                  {isFastDelivery && (
                    <Badge variant="secondary" className="gap-1">
                      Fast Delivery
                      <button onClick={() => setIsFastDelivery(false)}>
                        ×
                      </button>
                    </Badge>
                  )}
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          saree.images?.[0]
                            ? lehengaAPI.getImageUrl(saree.images[0])
                            : "/placeholder.svg"
                        }
                        alt={saree.name}
